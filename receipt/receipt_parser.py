...
with open('data.csv', 'w', newline='',encoding="utf8") as csvfile:
    ...
    writer.writerow(['ItemRowNumber', 'ItemName','TotalItemPrice2'])
    for ItemResult in ItemIterator1:
         writer.writerow([ItemResult.group("ItemRowNumber"), ItemResult.group("ItemName"), ItemResult.group("TotalItemPrice2")])

print("###########################")

ItemIterator2 = prog.findall(text)
for ItemResult in ItemIterator2:
    print(ItemResult[0],ItemResult[1],ItemResult[5])